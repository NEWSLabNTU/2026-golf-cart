...
"""Measure how well the live scan actually sits on the map.
    ...
    python3 scripts/localization/ndt_alignment_report.py --seconds 60
...
def main() -> int:
    ...
    parser.add_argument("--map", default="/home/aeon/Downloads/2026-04_ntu_map/merged/pointcloud_map.pcd")
    ...
    if not frames:
        ...
        print("  Check: python3 scripts/localization/check_ndt_activated.py", file=sys.stderr)
        return 1
