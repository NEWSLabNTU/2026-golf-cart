...
Verified on the master Orin (R36.4.4, sm_87): a CUDA kernel moved `load` from
0 to 999/1000 and VDD_GPU_SOC from 4.4 W to 25.9 W, so these are live readings
and not a stub.
...
See docs/research/system/where-the-orin-cpu-goes.md, finding 5.
"""
