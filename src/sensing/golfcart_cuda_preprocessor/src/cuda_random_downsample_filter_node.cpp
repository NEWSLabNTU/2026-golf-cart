...
#include "golfcart_cuda_preprocessor/cuda_random_downsample_filter_node.hpp"
...
namespace golfcart::cuda_preprocessor
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(golfcart::cuda_preprocessor::CudaRandomDownsampleFilterNode)
