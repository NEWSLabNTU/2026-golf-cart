...
def launch_setup(context, *args, **kwargs):
    ...
    if IfCondition(LaunchConfiguration("run_preprocessing")).evaluate(context):
...
def generate_launch_description():
    ...
    # False leaves only glog + the Nebula driver in this container, so the
    # preprocessing stage can be owned by pointcloud_preprocessor.launch.py
    # and switched between CPU and CUDA. See that file.
    add_launch_arg("run_preprocessing", "True", "run crop/distortion/outlier here")
